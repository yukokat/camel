...
| *operation* (producer) | Operation to perform. There are 9 enums and the value can be one of: batch-delete-attributes, batch-put-attributes, delete-attributes, delete-domain, domain-metadata, get-attributes, list-domains, put-attributes, select | put-attributes | SdbOperations
