...
public final class CallRecordingEndpointConfiguration extends TwilioConfiguration {
    ...
    @UriParam
    @ApiParam(apiMethods = {@ApiMethod(methodName = "creator", description="The SID of the Call to associate the resource with"), @ApiMethod(methodName = "creator", description="The SID of the Call to associate the resource with"), @ApiMethod(methodName = "deleter", description="The Call SID of the resources to delete"), @ApiMethod(methodName = "deleter", description="The SID of the Call to associate the resource with"), @ApiMethod(methodName = "fetcher", description="The Call SID of the resource to fetch"), @ApiMethod(methodName = "fetcher", description="The SID of the Call to associate the resource with"), @ApiMethod(methodName = "reader", description="The Call SID of the resources to read"), @ApiMethod(methodName = "reader", description="The SID of the Call to associate the resource with"), @ApiMethod(methodName = "updater", description="The Call SID of the resource to update"), @ApiMethod(methodName = "updater", description="The SID of the Call to associate the resource with")})
    ...
    @UriParam
    @ApiParam(apiMethods = {@ApiMethod(methodName = "creator", description="The new status of the recording"), @ApiMethod(methodName = "creator", description="The new status of the recording"), @ApiMethod(methodName = "deleter", description="The new status of the recording"), @ApiMethod(methodName = "deleter", description="The new status of the recording"), @ApiMethod(methodName = "fetcher", description="The new status of the recording"), @ApiMethod(methodName = "fetcher", description="The new status of the recording"), @ApiMethod(methodName = "reader", description="The new status of the recording"), @ApiMethod(methodName = "reader", description="The new status of the recording"), @ApiMethod(methodName = "updater", description="The new status of the recording"), @ApiMethod(methodName = "updater", description="The new status of the recording")})
