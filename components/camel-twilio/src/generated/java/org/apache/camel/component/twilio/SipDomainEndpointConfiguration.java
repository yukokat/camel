...
public final class SipDomainEndpointConfiguration extends TwilioConfiguration {
    @UriParam
    @ApiParam(apiMethods = {@ApiMethod(methodName = "creator", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "creator", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "deleter", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "deleter", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "fetcher", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "fetcher", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "reader", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "reader", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "updater", description="The unique address on Twilio to route SIP traffic"), @ApiMethod(methodName = "updater", description="The unique address on Twilio to route SIP traffic")})
