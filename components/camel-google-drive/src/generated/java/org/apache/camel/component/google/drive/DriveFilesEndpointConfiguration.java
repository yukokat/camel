...
@ApiParams(apiName = "drive-files", description = "The files collection of methods",
           apiMethods = {@ApiMethod(methodName = "copy", description="Creates a copy of the specified file"), @ApiMethod(methodName = "delete", description="Permanently deletes a file by ID"), @ApiMethod(methodName = "emptyTrash", description="Permanently deletes all of the user's trashed files"), @ApiMethod(methodName = "export", description="Exports a Google Doc to the requested MIME type and returns the exported content"), @ApiMethod(methodName = "generateIds", description="Generates a set of file IDs which can be provided in insert requests"), @ApiMethod(methodName = "get", description="Gets a file's metadata by ID"), @ApiMethod(methodName = "insert", description="Insert a new file"), @ApiMethod(methodName = "insert", description="Insert a new file"), @ApiMethod(methodName = "list", description="Lists the user's files"), @ApiMethod(methodName = "patch", description="Updates file metadata and/or content"), @ApiMethod(methodName = "touch", description="Set the file's updated time to the current server time"), @ApiMethod(methodName = "trash", description="Moves a file to the trash"), @ApiMethod(methodName = "untrash", description="Restores a file from the trash"), @ApiMethod(methodName = "update", description="Updates file metadata and/or content"), @ApiMethod(methodName = "update", description="Updates file metadata and/or content"), @ApiMethod(methodName = "watch", description="Subscribe to changes on a file")})
@UriParams
@Configurer
