...
| *operation* (producer) | The operation to do in case the user don't want to send only a message. There are 3 enums and the value can be one of: send-batch-message, delete-message, list-queues |  | SqsOperations
