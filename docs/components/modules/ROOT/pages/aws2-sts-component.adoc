...
| *operation* (producer) | *Required* The operation to perform. There are 3 enums and the value can be one of: assume-role, get-session-token, get-federation-token | assume-role | STS2Operations
