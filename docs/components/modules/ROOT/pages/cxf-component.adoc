...
|===
| Name | Description | Default | Type
| *dataFormat* (common) | The data type messages supported by the CXF endpoint. There are 5 enums and the value can be one of: payload, raw, message, cxf-message, pojo | pojo | DataFormat
