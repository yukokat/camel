...
| *operation* (producer) | *Required* The operation to perform. There are 6 enums and the value can be one of: list-keys, create-key, disable-key, schedule-key-deletion, describe-key, enable-key |  | KMS2Operations
