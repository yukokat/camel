...
| *operation* (producer) | *Required* The operation to perform. It can be createAndRunInstances, startInstances, stopInstances, terminateInstances, describeInstances, describeInstancesStatus, rebootInstances, monitorInstances, unmonitorInstances, createTags or deleteTags. There are 11 enums and the value can be one of: create-and-run-instances, start-instances, stop-instances, terminate-instances, describe-instances, describe-instances-status, reboot-instances, monitor-instances, unmonitor-instances, create-tags, delete-tags |  | AWS2EC2Operations
