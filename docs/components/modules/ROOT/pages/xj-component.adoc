...
| *transformDirection* (producer) | *Required* Transform direction. Either XML2JSON or JSON2XML. There are 2 enums and the value can be one of: xml2-json, json2-xml |  | TransformDirection
